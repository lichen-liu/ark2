...
public class AdminEnrollment {
    ...
    public void enroll(boolean overwritePrev) throws Exception {
        ...
        final String entityName = "admin";
        // Check to see if we've already enrolled the admin user.
        if (wallet.get(entityName) != null) {
            if (!overwritePrev) {
                System.out.println(
                        "An identity for the admin user \"" + entityName + "\" already exists in the wallet, reuse");
                return;
            } else {
                System.out.println("An identity for the admin user \"" + entityName
        ...
        Enrollment enrollment = caClient.enroll(entityName, "adminpw", enrollmentRequestTLS);
