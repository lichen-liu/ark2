...
public class ForumJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        viewPointBalanceChartJPanelLayout.setVerticalGroup(viewPointBalanceChartJPanelLayout
                .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 500, Short.MAX_VALUE));
        ...
        viewPointBalanceJPanelLayout.setHorizontalGroup(viewPointBalanceJPanelLayout
                .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(viewPointBalanceJPanelLayout.createSequentialGroup().addContainerGap(1200, Short.MAX_VALUE)
                        .addComponent(viewPointBalanceRefreshJButton).addContainerGap())
                .addComponent(viewPointBalanceChartJPanel, javax.swing.GroupLayout.Alignment.TRAILING,
                        javax.swing.GroupLayout.DEFAULT_SIZE, 1287, Short.MAX_VALUE));
        viewPointBalanceJPanelLayout.setVerticalGroup(
                viewPointBalanceJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(viewPointBalanceJPanelLayout.createSequentialGroup()
                                .addComponent(viewPointBalanceRefreshJButton)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(viewPointBalanceChartJPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 500,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void viewPointBalanceRefreshJButtonActionPerformed(final java.awt.event.ActionEvent evt) {// GEN-FIRST:event_viewPointBalanceRefreshJButtonActionPerformed
        ...
        final var pointBalanceHistoryByRelativeOrderSeries = new XYSeries("Point Balance By Relative Order");
        final var pointBalanceChangesHistoryByRelativeOrderSeries = new XYSeries(
                "Point Balance Changes By Relative Order");
        for (int index = 0; index < pointTransactionKeys.length; index++) {
            pointBalanceHistoryByRelativeOrderSeries.add(index, orderedPointBalanceHistory.get(index));
            pointBalanceChangesHistoryByRelativeOrderSeries.add(index, orderedPointBalanceChangesHistory.get(index));
        ...
        dataset.addSeries(pointBalanceHistoryByRelativeOrderSeries);

        final JFreeChart chart = ChartFactory.createXYLineChart("Point Balance By Order", "Order", "Point Balance",
